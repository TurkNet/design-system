...
exports.ContainerStyled = styled_components_1.default.div `
  ...
  .react-datepicker-popper[data-placement^='bottom']
    .react-datepicker__triangle::before {
    border-bottom-color: ${styled_1.color('grey.400')};
  }
  .react-datepicker-popper[data-placement^='bottom']
    .react-datepicker__triangle {
    top: 0;
  ...
  .react-datepicker-popper[data-placement^='bottom']
    .react-datepicker__triangle::after {
    border-top: none;
    border-bottom-color: ${styled_1.color('grey.300')};
  }
  .react-datepicker-popper[data-placement^='bottom']
    .react-datepicker__triangle::after {
    top: 0;
  ...
  .react-datepicker-popper[data-placement^='top']
    .react-datepicker__triangle::after {
    border-bottom: none;
    border-top-color: ${styled_1.color('grey.100')};
  }
  .react-datepicker-popper[data-placement^='top']
    .react-datepicker__triangle::after {
    bottom: 0;
  ...
  .react-datepicker-popper[data-placement^='top']
    .react-datepicker__triangle::before {
    bottom: -1px;
    border-top-color: ${styled_1.color('grey.400')};
  }
  ...
  .react-datepicker__time-container {
    float: right;
    border-left: 1px solid ${styled_1.color('grey.400')};
    width: 85px;
  }
  .react-datepicker__time-container--with-today-button {
    display: inline;
    border: 1px solid ${styled_1.color('grey.400')};
  ...
  .react-datepicker__time-container
    ...
    border: 2px solid ${styled_1.color('primary.normal')};
  }
  .react-datepicker__time-container
    .react-datepicker__time
    .react-datepicker__time-box
    ...
    background-color: ${styled_1.color('primary.normal', 0.2)};
  }
  .react-datepicker__time-container
    .react-datepicker__time
    .react-datepicker__time-box
  ...
  .react-datepicker__day-names {
    border-top: 1px solid ${styled_1.color('grey.400')};
    border-bottom: 1px solid ${styled_1.color('grey.400')};
  }
  ...
  .react-datepicker__month-year-option:hover {
    background-color: ${styled_1.color('grey.600')};
  }
  .react-datepicker__year-option:hover
    .react-datepicker__navigation--years-upcoming,
  .react-datepicker__month-option:hover
  ...
  .react-datepicker__today-button {
    background: ${styled_1.color('grey.300')};
    border-top: 1px solid ${styled_1.color('grey.400')};
    cursor: pointer;
    text-align: center;
    font-weight: bold;
